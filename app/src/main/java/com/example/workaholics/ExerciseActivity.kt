...
import com.example.workaholics.databinding.ActivityExerciseBinding
import com.example.workaholics.databinding.DialogCustomBackConfirmationBinding
    ...
    private fun setRestProgressBar() {
        ...
        restTimer = object : CountDownTimer(10000, 1000) {
            override fun onTick(millisUntilFinished: Long) {
                restProgress++
                binding?.progressbar?.progress = 12 - restProgress
                binding?.tvTimer?.text =
                    (12 - restProgress).toString()
            }
